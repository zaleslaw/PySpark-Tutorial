...
# ROC_AUC = 0.5. Accuracy could be higher, but in skewed dataset ROC_AUC is better. We see that eatable animals are not found.
if __name__ == "__main__":
    ...
    print("Coefficients: " + str(model.coefficients) + " Intercept: " + str(model.intercept))
