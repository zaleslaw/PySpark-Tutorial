...
if __name__ == "__main__":
    ...
    output = assembler.transform(passengers.select("pclass", "sibsp", "parch", "survived").na.drop(how="any")).select("features", "survived")  # <============== drop row if it has nulls/NaNs in the next list of columns)
